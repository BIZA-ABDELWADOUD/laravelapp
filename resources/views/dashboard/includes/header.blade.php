...
{{--select available languages--}}
                ...
                <li class="">
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex  nav-item nav-link pr-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{asset('assets/img/flags/'.LaravelLocalization::getCurrentLocaleName().'.jpg')}}" alt="img"></span>
                            <div class="my-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            ...
                            <a class="dropdown-item d-flex " rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                <span class="avatar  mr-3 align-self-center bg-transparent"><img src="{{asset('assets/img/flags/'.$properties['name'].'.jpg')}}" alt="img"></span>
                                <div class="d-flex">
            ...
            {{-- end select available languages--}}
                    ...
                    <div class="dropdown-menu">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                           ...
                           onclick="event.preventDefault();
                                                this.closest('form').submit();"><i class="bx bx-log-out"></i> Sign Out</x-dropdown-link>
                        </form>
                    </div>
                </div>
